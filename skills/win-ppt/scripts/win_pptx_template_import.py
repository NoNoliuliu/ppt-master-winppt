...
from win_legacy.template_import.externalize_images import discover_svg_files, externalize_svg_batch
from win_legacy.template_import.manifest import build_manifest
from win_legacy.template_import.optimize_reference import optimize_reference_batch
