...
def main() -> None:
    ...
    parser.add_argument(
        "--negative_prompt", "--negative-prompt", "-n", default=None,
        help="Local compatibility: items to avoid in single-image generation."
    )
    args = parser.parse_args()
    if args.negative_prompt and args.manifest:
        parser.error("In manifest mode, include each negative instruction in its item prompt.")
    ...
    if args.negative_prompt:
        prompt += "\n\nAvoid the following: " + args.negative_prompt
