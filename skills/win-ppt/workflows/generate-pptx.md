...
python3 ${SKILL_DIR}/scripts/project_manager.py import-sources <project_path> <source_files_or_dirs...> --copy   # skip when content is only in conversation; another project's files are copied unless --move
```
